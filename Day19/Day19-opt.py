    ...
    if time == 0:
        ...
        if ore_out == cla_out == obs_out == geo_out == 0:
            ...
            while t < time:
                ...
                temp_geo_res += geo_rob
                t += 1
            # no_out = mining(ore_rob, cla_rob, obs_rob, geo_rob, temp_ore_res, temp_cla_res, temp_obs_res,
            #                 temp_geo_res, ore_ore_cst, cla_ore_cst, obs_ore_cst, obs_cla_cst, geo_ore_cst,
            #                 geo_obs_cst, 0)
            no_out = temp_geo_res
...
with open('day19.txt', 'r') as file:
    ...
    while line and i <= 3:
        ...
        print(i, mining(ore_rob, cla_rob, obs_rob, geo_rob, ore_res, cla_res, obs_res, geo_res,
                        ore_ore_cst, cla_ore_cst, obs_ore_cst, obs_cla_cst, geo_ore_cst, geo_obs_cst, 28))
